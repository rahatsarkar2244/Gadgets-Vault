...
<section class="products">
   ...
   <a href="quick_view.php?pid=<?= $fetch_wishlist['pid']; ?>" class="icon quick-view fas fa-eye"></a>

   <a href="chat.php" class="icon message fas fa-comment"></a>

   <img src="project images/<?= $fetch_wishlist['image']; ?>" alt="">
